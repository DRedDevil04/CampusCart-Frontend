        ...
        <Drawer isOpen={isOpen} placement='left' onClose={onClose} finalFocusRef={btnRef}>
            <DrawerContent maxW={{ base: "80%", sm: "250px" }}>
                <Box mt={2} display="flex" alignItems="center" p={4} width="100%">
                    <Text flex="1" fontSize="3xl" fontWeight="bold">Navbar</Text>
                    <IconButton
                        ml="40px"
                        variant="outline"
                        onClick={onClose}
                ...
                <DrawerBody>
                    <Flex p="5%" flexDir="column" width="100%" as="nav">
                        <NavItem icon={MdDashboard} title="Dashboard" onClick={() => { navigate("/"); onClose(); }} />
                        <NavItem icon={FaUser} title="Users" onClick={() => { navigate('/userpage'); onClose(); }} />
